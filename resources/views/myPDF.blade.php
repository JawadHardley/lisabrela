            ...
            <div class="col-md-12 border-black" >
                <div class="col-md-12 border-yellow" >
                    <div class="col-md-12 border-green" >
                        ...
                        <div class="col-md-12" style="">
                            <center><h5>B.L. No:  {{ $license->license_number }}</h5></center>
                        </div>
                        <div class="col-md-12"  style="">
                        ...
                        <div class="col-md-12" style="margin-top: 20px">
                            <ol>
                                ...
                                <li>Business Details: <br>
                                    ...
                                    <div class="row" style="margin-left: 20px;"><div class="col-md-1" >OwnerShip Type: <b>{{ $listing->entity }}</b></div></div>
                                    <div class="row" style="margin-left: 20px;"><div class="col-md-1" >Business Type: <b>{{ $listing->type }}</b></div></div>
                                    <div class="row" style="margin-left: 20px;"><div class="col-md-1" >Region: <b>{{ $listing->region }}</b></div></div>
                                    <div class="row" style="margin-left: 20px;"><div class="col-md-1" >District: <b>{{ $listing->district }}</b></div></div>
                                </li>
                                    <div class="row" style="color: #0a121c;margin-top: 10px;">
                                        <div class="col-md-6">
                                            Date of Issue: <b style="margin-right: 100px">{{ $license->created_at }}</b>


                                            Expiring Date: <b>{{ $license->expire }}</b>
                                        </div>
                                    </div>
                            </ol>
                        </div>
