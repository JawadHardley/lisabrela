                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                          <input id="email" type="email" placeholder="your@email.com" class="form-control <?php $__errorArgs = ['email'];
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\mrwrong\Applications\Web Files\Assing\lisabrela\resources\views/applicant/login.blade.php ENDPATH**/ ?>