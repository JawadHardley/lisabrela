    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="card" >
      <?php echo csrf_field(); ?>
        <div class="card-body">
          ...
          <h2 class="card-title text-center">Register Account <p class="small">(Government Official)</p></h2>
          <hr>
...
unset($__errorArgs, $__bag); ?>
        ...
        <input type="hidden" class="form-control" name="role" value="gvt">
    ...
    <div class="text-center text-muted mt-3">
        Already have account? <a href="/gvt/login" tabindex="-1">Login</a>
    </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\mrwrong\Applications\Web Files\Assing\lisabrela\resources\views/gvt/register.blade.php ENDPATH**/ ?>