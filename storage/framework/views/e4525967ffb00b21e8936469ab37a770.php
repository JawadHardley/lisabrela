                  ...
                  <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($listing->district == Auth::user()->district && !isset($listing->dater)): ?>
                        <?php if($listing->gvt != 1 && $listing->gvt !== 0): ?>
                         <?php if($listing->taxed !== 0 && $listing->taxed != 1): ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\mrwrong\Applications\Web Files\Assing\lisabrela\resources\views/tax/pendingapps.blade.php ENDPATH**/ ?>